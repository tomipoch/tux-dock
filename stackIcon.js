...
const POPUP_COLUMNS = 4;
const ICON_SIZE = 48;
const POPUP_ITEM_SIZE = 64;
const MAX_ITEMS_PREVIEW = 3; // Máximo de iconos apilados en el stack
...
export class StackPopup extends PopupMenu.PopupMenu {
    ...
    _loadItems() {
        try {
            ...
            while ((fileInfo = enumerator.next_file(null))) {
                ...
                if (!row || itemsInRow >= POPUP_COLUMNS) {
    ...
    _createFileItem(fileInfo, parentDir) {
        ...
        const item = new St.Button({
            ...
            style: `width: ${POPUP_ITEM_SIZE}px; height: ${POPUP_ITEM_SIZE}px; padding: 4px;`,
            reactive: true,
            track_hover: true
        });
...
export class StackIcon {
    ...
    _updateStackedIcons() {
        ...
        try {
            ...
            while ((fileInfo = enumerator.next_file(null)) && count < MAX_ITEMS_PREVIEW) {
